    ...
    <section id="teacher-of-art">
      <div className="flex flex-col md:grid md:grid-cols-12 gap-x-[1.5vw]">
        <div className="md:col-span-6 md:col-start-4">
          ...
          <h3 className="text-base text-center font-nib">
          ...
          <div className="flex flex-col text-2xl gap-5 lg:gap-8 leading-snug font-normal font-nib text-center mt-40 lg:mt-72">
            ...
            <p>
              Otan esimerkiksi kestävyyden: miten omaa kestävyysajattelua voi
              tuoda esiin muutamien tuntien opetusnäytöillä per luokka. Miten
              oman kestävyysajattelun voi muuntaa todeksi tilassa ja yhteisössä,
